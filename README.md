...
<!-- Increases users balance in given currency by amount value -->
...
<!-- Decreases users balance in given currency by amount value -->
<!-- Returns new_balance of the user in given format -->
...
<!-- Decreases from_users balance in given currency by amount value -->
<!-- Increases to_users balance in given currency by amount value -->
